...
const Layout = ({ children, page = 'Inicio' }) => {
    return (
        <div className='h-full text-cafe text-2xl text-justify'>
            <Head>
                <title>{`Armonia Nutritiva - ${page}`}</title>
                <link rel="icon" href="/favicon.ico" />
                <meta
                    name="Armonia Nutritiva"
                    content="💆🏻‍♀️Psiconutrición🥗Emociónes💫 Mente🏃🏻‍♀️Cuerpo🙏🏻Espíritu✨Energía"
                />
            </Head>
            {/* Decorations */}
            <div className={`${styles.customShapeDividerTop1606848837} ${styles.fadeIn} relative`}>
                <svg
                    data-name="Layer 1"
